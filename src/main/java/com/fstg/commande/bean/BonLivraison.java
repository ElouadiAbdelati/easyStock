...
public class BonLivraison implements Serializable {
    ...
    private List<LivraisonItem> livraisonItems = new ArrayList<LivraisonItem>();
    ...
    public String toString() {
        return "BonLivraison{" + "id=" + id + ", commande=" + commande + ", dateLaivraison=" + dateLaivraison + ", remise=" + remise + '}';
    }
